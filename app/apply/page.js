            ...
            <div className="w-full p-5">
              <div className="w-full sm:flex">
                <div className="w-full sm:w-1/2 p-10  pb-0">
                  ...
                  an application is submitted.</p>
                  <p className="text-lg sm:text-xl leading-relaxed mb-4">Submission of an Exhibitor Application does not guarantee
                  participation in the event. All applications are reviewed by
                  the organizers and applicants notified of their acceptance.
                  Any exhibitor not approved for the festival will be notified
                  and will receive a full refund of all application and
                  equipment fees.</p>
                  <p className="text-lg sm:text-xl leading-relaxed mb-4">Exhibitors filing late applications and/or payments will be
                  assessed a 25% late fee which is due with the application.
                  Exhibitors with outstanding debt to the OTSFM or Fretboard
                  Journal will not be allowed to participate until outstanding
                  financial obligations are rectified.</p>
                </div>
                <div className="w-full sm:w-1/2 p-10  pb-0">
                  <p className="underline mt-4  text-lg leading-relaxed">WAITLIST POLICY</p>
                
                  <p className="text-lg sm:text-xl leading-relaxed mb-4">
                  The organizers do not assign a Wait List number to artists.
                  We do however, maintain a Wait List of luthiers and continue
                  to extend invitations all the way until the day before
                  festival set-up. If a slot becomes available, an artisan from
                  the Wait List will be selected based on the organizers
                  evaluation and availability. Artists will be contacted as
                  soon as possible when space becomes available.
                  </p>

                  <p className="underline mt-4  text-lg leading-relaxed">CANCELLATIONS</p>
                  ...
                  <p className="text-lg sm:text-xl leading-relaxed mb-4">
                  With regard to COVID: Should government mandated
                  restrictions on mass gatherings put forth by the city,
                  county, state or federal government agencies or any safety
                  concerns related to the COVID-19 pandemic, result in the
                  cancellation of an in-person event, all booth fees (minus
                  credit card fees when applicable) will be refundable.</p>
                </div>
              </div>
            </div>
